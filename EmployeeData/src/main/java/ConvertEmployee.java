...
public class ConvertEmployee extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			while (r.next()) {
				...
				//pw.print(ed.getEmpl_id()+": :"+ed.getId()+": :");
				ed.getEmpl_id();
				ed.getId();
				ed.getEmpl_name();
				ed.getPhone_number();
				...
				File jsonfile = new File ("C:\\Users\\91965\\eclipse-workspace\\EmployeeData\\emplinfo.json");
				ObjectMapper om =new ObjectMapper();
				om.writeValue(jsonfile,ed);
				c.close();
